...
class JournalModelTestCase(TestCase):
    def setUp(self):
        ...
        Journal.objects.create(user=user, strategy='Test Strategy', instrument='Test Instrument')
...
class JournalViewTestCase(TestCase):
    ...
    def test_journal_detail_authenticated(self):
        journal = Journal.objects.create(user=self.user, strategy='Test Strategy', instrument='Test Instrument')
